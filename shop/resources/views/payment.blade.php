...
<div>
    <div class="g-pay-lst">
                ...
                <li style="height:50px;">
                    <a href="">
                        ...
                        <dl>
                            ...
                            <dd>
                                购买数量：<em class="price">{{$v->buy_number}}</em>
                                &nbsp;&nbsp;
                                <em>￥<b>{{$v->self_price}}</b></em>
                            </dd>
                        </dl>
                    </a>
                </li>
        ...
        <p class="gray9">总需支付金额：<em class="orange"><i>￥</i>0.00</em></p>
    </div>
    <br>
    ...
    <div class="g-Total-bt">
        <dd><a id="btnPay" href="{{url('cart/paysuccess')}}" class="orangeBtn fr w_account">立即支付</a></dd>
    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            for(var i = 0;i<$('.g-pay-lst li').length;i++){
                buy_number = parseInt($('.g-pay-lst li').eq(i).find('dd em.price').text());
                self_price = parseInt($('.g-pay-lst li').eq(i).find('dd em b').text());
                total +=buy_number*self_price;
